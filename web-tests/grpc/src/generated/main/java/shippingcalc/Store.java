...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return shippingcalc.ShippingcalcOuterClass.internal_static_shippingcalc_Store_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            shippingcalc.Store.class, shippingcalc.Store.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof shippingcalc.Store)) {
      return super.equals(obj);
    }
    shippingcalc.Store other = (shippingcalc.Store) obj;
  ...
  public static shippingcalc.Store parseFrom(
  ...
  public static shippingcalc.Store parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static shippingcalc.Store parseFrom(
  ...
  public static shippingcalc.Store parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static shippingcalc.Store parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static shippingcalc.Store parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(shippingcalc.Store prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using shippingcalc.Store.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public shippingcalc.Store getDefaultInstanceForType() {
      return shippingcalc.Store.getDefaultInstance();
    }

    @java.lang.Override
    public shippingcalc.Store build() {
      shippingcalc.Store result = buildPartial();
    ...
    @java.lang.Override
    public shippingcalc.Store buildPartial() {
      shippingcalc.Store result = new shippingcalc.Store(this);
      result.id_ = id_;
      result.lat_ = lat_;
      result.lon_ = lon_;
      onBuilt();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof shippingcalc.Store) {
        return mergeFrom((shippingcalc.Store)other);
      } else {
    ...
    public Builder mergeFrom(shippingcalc.Store other) {
      if (other == shippingcalc.Store.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      shippingcalc.Store parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (shippingcalc.Store) e.getUnfinishedMessage();
  ...
  private static final shippingcalc.Store DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new shippingcalc.Store();
  }

  public static shippingcalc.Store getDefaultInstance() {
