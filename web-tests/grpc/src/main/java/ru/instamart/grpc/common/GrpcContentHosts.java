...
public final class GrpcContentHosts {
    ...
    public static final String PAAS_CONTENT_OPERATIONS_ETA = EnvironmentProperties.Env.ETA_NAMESPACE + ".k-stage.sbmt.io";
    ...
    public static final String PAAS_CONTENT_OPERATIONS_SURGELEVEL = EnvironmentProperties.Env.SURGE_LEVEL_NAMESPACE + ".k-stage.sbmt.io";
