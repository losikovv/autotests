...
@Slf4j
public final class WorkflowExecutionListener extends ApiExecutionListener {

    // Нужно инициализировать в конструкторе, что бы гарантировать наличие конфигов до запуска чего либо
    public WorkflowExecutionListener() {
        super();
    }
    ...
    public void revealKraken() {
        log.debug("gRPC {}", GrpcContentHosts.PAAS_CONTENT_OPERATIONS_WORKFLOW);
