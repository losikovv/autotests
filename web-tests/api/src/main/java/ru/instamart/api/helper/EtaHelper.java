...
public class EtaHelper {
    ...
    public static void addStore(final String storeUuid, final Float lat, final Float lon, final String timezone,
                                ...
                                final String closingDelta, final Boolean isSigmaEnabled, final Boolean isSurgeEnabled, final Integer retailerId) {
        final var isStoreAdded = StoreParametersDao.INSTANCE.addStore(storeUuid, lat, lon, timezone, isMlEnabled, openingTime, closingTime, closingDelta, isSigmaEnabled, isSurgeEnabled, retailerId);
