...
public class KafkaHelper {
    ...
    public List<Surgelevelevent.SurgeEvent> waitDataInKafkaTopicSurgeLevel(String storeId, long time) {
        var kafkaConsumers = new KafkaConsumers(configSurgeLevel(), time);
