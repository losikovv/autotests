...
import ru.instamart.api.model.shopper.admin.ScangoRetailerConfigSHP;
import ru.instamart.api.model.shopper.admin.ScangoStoreConfigSHP;
...
public class ShopperAdminRequest extends ShopperAdminRequestBase {
    ...
    public static class Scango {
        ...
        public static class Retailer {
            ...
            @Step("{method} /" + ShopperAdminEndpoints.Scango.RETAILERS_CONFIG)
            public static Response PUT(final int retailerId, final ScangoRetailerConfigSHP config) {
                return givenWithAuth()
                        .contentType(ContentType.JSON)
                        .body(config)
                        .put(ShopperAdminEndpoints.Scango.RETAILERS_CONFIG, retailerId);
            }

            @Step("{method} /" + ShopperAdminEndpoints.Scango.RETAILERS_CONFIG)
            public static Response GET(final Integer sid) {
                return givenWithAuth()
                        .get(ShopperAdminEndpoints.Scango.RETAILERS_CONFIG, sid);
            }
        }

        public static class Store {

            @Step("{method} /" + ShopperAdminEndpoints.Scango.STORES_CONFIG)
            public static Response PUT(final ScangoStoreConfigSHP config, final String storeUUID) {
                return givenWithAuth()
                        .contentType(ContentType.JSON)
                        .body(config)
                        .put(ShopperAdminEndpoints.Scango.STORES_CONFIG, storeUUID);
            }

            @Step("{method} /" + ShopperAdminEndpoints.Scango.STORES_CONFIG)
            public static Response GET(final String uuid) {
                return givenWithAuth()
                        .get(ShopperAdminEndpoints.Scango.STORES_CONFIG, uuid);
            }
        }

        public static class SoftChecks {

            @Step("{method} /" + ShopperAdminEndpoints.Scango.SOFT_CHECKS)
            public static Response POST(final int assemblyId) {
                return givenWithAuth()
                        .post(ShopperAdminEndpoints.Scango.SOFT_CHECKS, assemblyId);
            }
        }
