...
public class StoresAdminRequest extends AdminRequestBase {
    ...
    public static Store getStoreLentaOrekhoviyBulvar() {
        ...
        return Store.builder()
                ...
                .externalAssemblyKind(ExternalAssemblyKind.DELIVERY_BY_SBERMARKET.getValue())
                .sendCreatedHook("immediately")
                .onDemand(0)
                .isMlEnabled(0)
                .avgPositionsPerPlace(10)
    ...
    public static Store getStoreLentaElino() {
        ...
        return Store.builder()
                ...
                .hoursOrderEditLocked(0)
                .externalAssemblyEnabled(1)
                .externalAssemblyKind(ExternalAssemblyKind.INTEGRATION_FOR_ACCOUNTING.getValue())
                .sendCreatedHook("immediately")
                .onDemand(0)
                .isMlEnabled(0)
                .avgPositionsPerPlace(10)
    ...
    public static Store getStoreVictoriaTest() {
        ...
        return Store.builder()
                ...
                .hoursOrderEditLocked(0)
                .externalAssemblyEnabled(1)
                .externalAssemblyKind(ExternalAssemblyKind.DELIVERY_BY_RETAILER.getValue())
                .sendCreatedHook("immediately")
                .onDemand(0)
                .isMlEnabled(0)
                .avgPositionsPerPlace(10)
