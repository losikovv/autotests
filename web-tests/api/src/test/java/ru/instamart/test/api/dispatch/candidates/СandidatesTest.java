package ru.instamart.test.api.dispatch.candidates;
...
import static ru.instamart.grpc.common.GrpcContentHosts.PAAS_CONTENT_CANDIDATES_ETA;
...
public class СandidatesTest extends RestBase {
    ...
    public void auth() {
        ...
        clientCandidates = CandidatesGrpc.newBlockingStub(grpc.createChannel(PAAS_CONTENT_CANDIDATES_ETA));
    }
