...
public class CreditCardsV2Test extends RestBase {
    ...
    public void addANewCardWithRequiredParameters() {
        ...
        final CreditCard creditCard = CreditCard.builder()
                ...
                .cryptogram_packet(CreditCardsV2.CARD1.getCryptogramPacket())
                .build();
        ...
        softAssert.assertEquals(creditCards.getCreditCard().getYear(), CreditCardsV2.CARD1.getYear(), "Год не совпадает");
        softAssert.assertEquals(creditCards.getCreditCard().getMonth(), CreditCardsV2.CARD1.getMonth(), "Месяц не совпадает");
