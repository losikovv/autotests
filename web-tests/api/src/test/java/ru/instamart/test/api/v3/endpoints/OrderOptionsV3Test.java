...
public final class OrderOptionsV3Test extends RestBase {
    ...
    @JsonDataProvider(path = "data/json/api_v3_test_data_goods.json", type = ApiV3DataProvider.ApiV3TestDataRoot.class)
    ...
    @CaseId(855)
    @Story("Опции доставки")
    @JsonDataProvider(path = "data/json/api_v3_test_data_sber_devices.json", type = ApiV3DataProvider.ApiV3TestDataRoot.class)
    @Test(groups = {"api-instamart-regress"},
            dataProvider = "json",
            dataProviderClass = JsonProvider.class,
    ...
    @CaseId(854)
    @Story("Опции доставки")
    @JsonDataProvider(path = "data/json/api_v3_test_data_metro_marketplace.json", type = ApiV3DataProvider.ApiV3TestDataRoot.class)
    @Test(groups = {"api-instamart-regress"},
            dataProvider = "json",
            dataProviderClass = JsonProvider.class,
