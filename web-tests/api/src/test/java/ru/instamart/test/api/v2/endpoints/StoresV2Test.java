...
public final class StoresV2Test extends RestBase {
    ...
    @CaseId(188)
    @JsonDataProvider(path = "data/json/api_v2_negative_store_data.json", type = RestDataProvider.StoreDataRoot.class)
    ...
    @CaseId(190)
    @JsonDataProvider(path = "data/json/api_v2_positive_store_data.json", type = RestDataProvider.StoreDataRoot.class)
    @Test(groups = {"api-instamart-regress"},
            dataProvider = "json",
            dataProviderClass = JsonProvider.class,
