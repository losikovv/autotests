...
public final class TeamServiceImpl implements TeamService {
    ...
    public Users getAll(int limit, int offset) {
        return qaseApiClient.get(Users.class, "/ru.instamart.ui.user", emptyMap(), null, limit, offset);
    }
    ...
    public User get(long id) {
        return qaseApiClient.get(User.class, "/ru.instamart.ui.user/{id}", singletonMap("id", id), emptyMap());
    }
}
