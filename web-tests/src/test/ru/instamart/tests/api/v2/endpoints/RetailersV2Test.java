...
import instamart.api.requests.v2.RetailersRequest;
import instamart.api.responses.v2.RetailersResponse;
...
public final class RetailersV2Test extends RestBase {
    ...
    @Story("Получение ретейлера по невалидному retailer id")
