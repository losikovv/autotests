...
import ru.instamart.autotests.application.libs.CheckoutSteps;
...
public class Checkout extends Base {
    ...
    public Checkout(WebDriver driver, EnvironmentData environment, ApplicationManager app) {
    ...
    public static class AddressStep {
        ...
        public static void next(){
            Checkout.hitNext(addressStep());
        }

        public static void change(){
            Checkout.hitChange(addressStep());
        }

        public static void save(){
            Checkout.hitSave(addressStep());
        }
    ...
    public static class ContactsStep {
        ...
        public static void next() {
            Checkout.hitNext(contactsStep());
        }

        public static void change() {
            Checkout.hitChange(contactsStep());
        }

        public static void save() {
            Checkout.hitSave(contactsStep());
        }
    ...
    public static class ReplacementsStep {
        ...
        public static void next() {
            Checkout.hitNext(replacementsStep());
        }

        public static void change() {
            Checkout.hitChange(replacementsStep());
        }

        public static void save() {
            Checkout.hitSave(replacementsStep());
        }
    }
    ...
    public static class PaymentStep {
        ...
        public static void next() {
            Checkout.hitNext(paymentStep());
        }

        public static void change() {
            Checkout.hitChange(paymentStep());
        }

        public static void save() {
            Checkout.hitSave(paymentStep());
        }
    }
    ...
    public static class DeliveryStep {
        ...
        public static void next() {
            Checkout.hitNext(deliveryStep());
        }

        public static void change() {
            Checkout.hitChange(deliveryStep());
        }

        public static void save() {
            Checkout.hitSave(deliveryStep());
        }
    }
