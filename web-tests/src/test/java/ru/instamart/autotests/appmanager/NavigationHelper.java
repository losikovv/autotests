...
public class NavigationHelper extends HelperBase {
    ...
    public void goToProfile() {
        ...
        kraken.perform().click(By.xpath("//*[@id='wrap']/div[1]/div/div/header/div[1]/div[5]/div/div[1]"));
        // клик по кнопке Профиль
        kraken.perform().click(By.linkText("Профиль"));
    }

    public void goToHomepage() {
        // клик по кнопке Главная
        kraken.perform().click(By.linkText("Главная"));
    }
    ...
    public void goProfile() {
        kraken.perform().click(Elements.Admin.Header.profileButton());
    }
    ...
    public void goBackToList() {
        kraken.perform().click(Elements.Admin.Header.backToListButton());
    }
