...
public class SpreeOptionTypesDao extends AbstractDao<Long, SpreeOptionTypesEntity> {
    ...
    public SpreeOptionTypesEntity getByName(String typeName) {
        ...
        try (final var connect = ConnectionManager.getDataSource(Db.MYSQL_STF).getConnection();
             final var preparedStatement = connect.prepareStatement(String.format(SELECT_SQL, "t.id, t.name, t.presentation, v.name as valueName, v.presentation as valuePresentation") +
