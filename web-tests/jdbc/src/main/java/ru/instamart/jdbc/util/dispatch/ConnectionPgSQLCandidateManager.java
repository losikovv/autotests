...
import static ru.instamart.jdbc.enums.dispatch.Services.CANDIDATES;
...
public class ConnectionPgSQLCandidateManager {
    ...
    private ConnectionPgSQLCandidateManager() {
    }

    protected static void portForward() {
        K8sPortForward.getInstance().portForwardPgSQLService(CANDIDATES.getNamespace(), CANDIDATES.getPort());
    }
