...
public final class ChangingDeliverySlotTests {
    ...
    @Test(description = "Проверка возможности изменения слота доставки", groups = {POST_ORDERING, JOTUNHEIMR})
    ...
    @CaseId(3715)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка возможности изменения слота самовывоза", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3693)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка возможности изменения слота доставки/самовывоза с учетом промика бесплатной доставки в заказе", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3718)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка возможности изменения слота доставки/самовывоза с учетом промика в заказе", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3782)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка возможности изменения слота с обычного на OnDemand", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3695)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка невозможности изменения слота доставки когда оформлен OnDemand", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3719)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка невозможности изменения слота при невозможности изменения в выбранном магазине", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3712)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка невозможности изменения слота самовывоза, имея в шипменте алкоголь", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3714)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка невозможности изменения слота доставки, когда статус заказа старше статуса 'Ожидает сборки'", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
    ...
    @CaseId(3716)
    @Story("Изменение слота доставки")
    @Test(description = "Проверка невозможности изменения слота самовывоза, когда статус заказа старше статуса 'Ожидает сборки'", groups = {POST_ORDERING, JOTUNHEIMR})
    @CookieProvider(cookies = {"FORWARD_FEATURE_STF", "COOKIE_ALERT", "RETAILERS_REMINDER_MODAL", "EXTERNAL_ANALYTICS_ANONYMOUS_ID_CHECKOUT"})
