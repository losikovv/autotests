...
public final class MultiretailerSearchTests {
    ...
    @CaseId(3847)
    @Test(description = "Недоступность межритейлерного поиска при невыбранном адресе", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3848)
    @Test(description = "Тест успешной отработки межритейлерного саджестора", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3849)
    @Test(description = "Открытие карточки товара из межритейлерного саджестора", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3850)
    @Test(description = "Добавление товара в корзину из межритейлерного саджестора", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3851)
    @Test(description = "Успешная отработки межритейлерного поиска", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3852)
    @Test(description = "Открытие карточки товара в межритейлерном поиске", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3853)
    @Test(description = "Добавление товара в корзину в межритейлерном поиске", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3854)
    @Test(description = "Добавление товара в любимые в межритейлерном поиске", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3855)
    @Test(description = "Переключения слага ритейлера в межритейлерном поиске", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3856)
    @Test(description = "Переключение категорий в межритейлерном поиске", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3858)
    @Test(description = "Недоступность межритейлерного поиска при самовывозе на главной", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    ...
    @CaseId(3859)
    @Test(description = "Недоступность межритейлерного поиска при самовывозе в результатах поиска", groups = {REGRESSION, MULTIRETAILER_SEARCH})
    public void testCheckMultisearchNotAvailableOnMultiearchPageViaPickup() {
        ...
        multiSearch().interactMultisearchHeader().interactAddress().selectFirstStore();
        multiSearch().interactMultisearchHeader().interactAddress().checkAddressModalIsNotVisible();
    ...
    @CaseId(3860)
    @Test(description = "Переключение слага ритейлера в межритейлерном саджесторе", groups = {REGRESSION, MULTIRETAILER_SEARCH})
