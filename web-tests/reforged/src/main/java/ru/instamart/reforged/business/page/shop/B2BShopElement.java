...
public interface B2BShopElement {
    ...
    Element firstProductSnippet = new Element(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li"), "Спиппет первого товара на странице");
    Button addFirstItemToFavorite = new Button(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//button[@title='Добавить в избранное']"), "Кнопка 'Добавить в избранное' у первого товара");
    Button plusFirstItemToCart = new Button(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//button[@title='Добавить в корзину']"), "Кнопка добавить в корзину у первого товара");
    Button minusFirstItemFromCart = new Button(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//button[contains(@title, 'Убрать из корзины')]"), "Кнопка убрать из корзины у первого товара");
    Element imageInFirstItem = new Element(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//img"), "Изображение первого товара");
    Element nameInFirstItem = new Element(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//h3"), "Название товара");
    Element packageSizeInFirstItem = new Element(By.xpath("//section[@data-qa='catalog_page_taxons_list_taxon_item_0']//li//h3/following-sibling::div[1]"), "Размер упаковки товара");
