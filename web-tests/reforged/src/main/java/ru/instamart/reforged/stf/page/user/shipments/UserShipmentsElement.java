...
public interface UserShipmentsElement {
    ...
    ElementCollection orderCancelStatuses = new ElementCollection(By.xpath("//div[@data-qa='user-shipment-list-shipment-state' and text() = 'Отменен']"), "Коллекция элементов статусов отмены у отмененных заказов");
}
