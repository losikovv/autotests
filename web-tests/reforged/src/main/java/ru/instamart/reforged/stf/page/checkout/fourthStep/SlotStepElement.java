...
public interface SlotStepElement {
    ...
    ElementCollection activeSlots = new ElementCollection(By.xpath("//div[(contains(@id, 'deliveryDay'))][not(contains(@class,'panel-items-container--hidden'))]//div[@class='windows-selector-item']"), "Коллекция активных слотов");
