...
public interface B2BHeaderElement {

    B2BAccountMenu accountMenu = new B2BAccountMenu();
    B2BTransferCartModal transferCartModal = new B2BTransferCartModal();
    B2BStoreSelector storeSelectorDrawer = new B2BStoreSelector();
