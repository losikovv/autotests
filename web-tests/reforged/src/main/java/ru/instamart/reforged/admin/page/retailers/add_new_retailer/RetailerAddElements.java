...
public interface RetailerAddElements {
    ...
    Input addressInput = new Input(By.xpath("//input[@data-qa='retailer_create_legal_address']"), "Инпут 'Юридический адрес' нового ретейлера на странице создания ретейлера");
