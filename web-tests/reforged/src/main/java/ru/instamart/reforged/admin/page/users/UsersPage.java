...
import static ru.instamart.reforged.admin.page.users.UsersElement.UsersEdit.*;
import static ru.instamart.reforged.admin.page.users.UsersElement.UsersMain.*;
