...
public interface SlotStepElement {
    ...
    ElementCollection activeSlots = new ElementCollection(By.xpath("//div[(contains(@id, 'deliveryDay'))]//div[@class='windows-selector-item']"));
    Button choseAnotherTimeButton = new Button(By.xpath("//button[contains(@class,'delivery_time')]"),"Выбрать другое время");
