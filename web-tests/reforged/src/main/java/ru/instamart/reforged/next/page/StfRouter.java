...
import ru.instamart.reforged.next.page.business.BusinessPage;
import ru.instamart.reforged.next.page.checkout.CheckoutPage;
import ru.instamart.reforged.next.page.faq.*;
import ru.instamart.reforged.next.page.home.HomePage;
import ru.instamart.reforged.next.page.landings.AeroflotPage;
import ru.instamart.reforged.next.page.landings.drivers_hiring.DriversHiringPage;
import ru.instamart.reforged.next.page.landings.gift.CertificatePage;
import ru.instamart.reforged.next.page.landings.job.JobPage;
import ru.instamart.reforged.next.page.notfound.Page404;
import ru.instamart.reforged.next.page.search.SearchPage;
import ru.instamart.reforged.next.page.seo.SeoCatalogPage;
import ru.instamart.reforged.next.page.seo_incognito.SeoIncognitoPage;
import ru.instamart.reforged.next.page.shop.ShopPage;
import ru.instamart.reforged.next.page.user.favorites.UserFavoritesPage;
import ru.instamart.reforged.next.page.user.profile.UserProfilePage;
import ru.instamart.reforged.next.page.user.shipments.UserShipmentsPage;
