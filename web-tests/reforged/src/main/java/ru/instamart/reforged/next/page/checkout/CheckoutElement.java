package ru.instamart.reforged.next.page.checkout;
...
import ru.instamart.reforged.next.frame.checkout.subsections.EditRequisites;
import ru.instamart.reforged.next.frame.checkout.subsections.add_payment_card.AddPaymentCard;
import ru.instamart.reforged.next.frame.checkout.subsections.create_company.AddCompany;
import ru.instamart.reforged.next.frame.checkout.subsections.edit_payment_card.EditPaymentCard;
import ru.instamart.reforged.next.frame.checkout.subsections.edit_phone_number.EditPhoneNumber;
import ru.instamart.reforged.next.frame.checkout.subsections.loyaltycard_modal.EditLoyaltyCard;
import ru.instamart.reforged.next.frame.checkout.subsections.promocode_modal.EditPromoCode;
import ru.instamart.reforged.next.frame.checkout.subsections.retailer_card.EditRetailerCard;
import ru.instamart.reforged.next.page.checkout.fifthStep.PaymentStep;
import ru.instamart.reforged.next.page.checkout.fifthStep.edit_company.EditCompany;
import ru.instamart.reforged.next.page.checkout.firstStep.DeliveryOptionStep;
import ru.instamart.reforged.next.page.checkout.fourthStep.SlotStep;
import ru.instamart.reforged.next.page.checkout.secondStep.ContactsStep;
import ru.instamart.reforged.next.page.checkout.thirdStep.ReplacementPolicyStep;
...
public interface CheckoutElement {
    ...
    Element editLoyaltyCard = new Element(ByKraken.xpathExpression("//div[contains(text(), '%s')]/ancestor::div[@class='loyalty-program__content']/following-sibling::div[@class='loyalty-program__edit']"),
            "редактирование карты лояльности");
    Element activeLoyaltyCard = new Element(ByKraken.xpathExpression("//div[@class='loyalty-program__name' and text()='%s']/ancestor::div[@class='loyalty-program loyalty-program--active']"),
