...
import ru.instamart.reforged.stf.page.checkout_new.CheckoutNewPage;
...
import ru.instamart.reforged.stf.page.user.shipments.edit.UserShipmentPage;
...
public final class StfRouter extends Router {
    ...
    public static UserShipmentPage userShipment() {
        return (UserShipmentPage) getPage(UserShipmentPage.class);
    }
    ...
    public static MultiSearchPage multiSearch() {
        return (MultiSearchPage) getPage(MultiSearchPage.class);
    }
    ...
    public static CheckoutNewPage checkoutNew() {
        return (CheckoutNewPage) getPage(CheckoutNewPage.class);
    }
