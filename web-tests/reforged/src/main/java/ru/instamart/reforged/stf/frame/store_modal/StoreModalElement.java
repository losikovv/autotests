...
public interface StoreModalElement {
    ...
    ElementCollection storeCards = new ElementCollection(By.xpath("//a[@data-qa='store-card']"), "карточки магазинов");
    Element storeCardBySid = new Element(ByKraken.xpathExpression("//a[@data-qa='store-card'][contains(@href,'/stores/%s')]"), "Карточка магазина по sid");
}
